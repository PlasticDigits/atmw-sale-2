...
import { useCall, useContractFunction, useEtherBalance, useEthers, useTokenAllowance, useTokenBalance } from '@usedapp/core';
...
function Home() {
  ...
  const { state: stateCzusdApprove, send: sendCzusdApprove } = useContractFunction(CONTRACT_CZUSD, 'approve');
  ...
  return (<>
    <section id="top" className="hero has-text-centered" style={{ backgroundColor: "#0e0505", minHeight: "85vh" }}>
      <video className="background-video" autoPlay loop muted >
        <source src={BackgroundVideo} type="video/mp4" />
      </video>
      <div className="hero-head has-text-left pb-5 mt-0 pt-1" style={{ position: "relative", width: "100%", backgroundColor: "#0e0505" }}>
        <div style={{ marginLeft: "auto", marginRight: "auto", maxWidth: "1080px" }}>
          <div className="mt-3 pb-0 mb-0" style={{ float: "left" }}>
            ...
            <p className="title ml-5 mt-4" style={{ color: "#e0cf4d" }}>Atomic Wealth</p>
            <p className="subtitle is-size-6 mr-5 " style={{ color: "#ddd" }}>The groundbreaking DeFi platform that empowers you to stake, mine, and grow your assets effortlessly.</p>
          </div>
          <Web3ModalButton />
      ...
      <div className='hero-body p-0 m-0 pt-5 pb-5' style={{ color: "#ddd", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container has-text-centered">
          <h2 className="is-size-3 mt-3">PRESALE:<br /> Use <span style={{ color: "#edb71d" }}>BNB</span> or <span style={{ color: "#4dc491" }}>STABLES</span></h2>
          <div className="p-2" style={{ maxWidth: "300px", marginLeft: "auto", marginRight: "auto" }}>
            <ul>
              ...
              <li style={{ textShadow: "0px 0px 4px black" }}>SALE PAUSED{startEpochTimer}</li>
            ...
            <button className='is-size-6 button is-primary'
              ...
              onClick={() => {
                ...
                if (isApproveNeeded) {
                  ...
                  if (selectedStable == "CZUSD") sendCzusdApprove(ADDRESS_DGGSALE, constants.MaxUint256);
